...
def submit_answers():
    ...
    # B2F: Verwendung von Funktionen als Argumente
...
def quiz_statistics():
    ...
    # Verwenden von filter, um Fragen mit mehr als 10 Zeichen im Text auszuwählen
    long_questions = list(filter(lambda q: len(q['question']) > 10, questions))

    # question_ids als Tupel gespeichert, da sie nicht mehr verändert werden soll
    ...
    # Verwendung von reduce, um die Gesamtanzahl der Buchstaben in den Fragen zu zählen
...
def filtered_and_mapped_questions():
    ...
    # Filtert Fragen mit mehr als 10 Zeichen und mappt anschließend die IDs der gefilterten Fragen
